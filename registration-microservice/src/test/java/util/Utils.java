...
public class Utils {
	...
	public static final List<String> codinomesEmUso = createCodinomesEmUsoList();
	...
	public static final PlayerRegistrationResponseDto playerRegistrationResponseDto = new PlayerRegistrationResponseDto(
			1L, "Tony Stark", "tony@stark.com", "11234567890", "Hulk", "VINGADORES");

	private static List<String> createCodinomesVingadoresList() {
		return Arrays.asList("Hulk", "Capitao America", "Pantera Negra", "Homem de Ferro", "Thor",
				"Feiticeira Escarlate", "Visao");
	}
	...
	private static List<String> createCodinomesEmUsoList() {
		return Arrays.asList("Hulk", "Capitao America", "Pantera Negra", "Homem de Ferro");
	}
